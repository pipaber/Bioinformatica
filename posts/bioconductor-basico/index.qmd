...
En fin, como ya te habrás percatado, este *post* es una pequeña introducción a los rangos genómicos asi que ¡vamos al asunto!
...
Ahora bien, trabajaremos esta introducción a los rangos genómicos con datos provenientes de un experimento de precipitación de inmuno cromatina (ChIP-Seq). Esta técnica tiene por objetivo secuenciar regiones específicas del genoma que son sitios de unión de proteínas como factores de transcripción.
...
La primera función que estudiaremos es `IRanges()`. La función tiene tres argumentos principales: inicio (*start*), fin (*end*) y ancho (*width*). Por ejemplo, si definimos un rango $[8,14] = 8,9,10,11,12,13,14$ tandrá un ancho o *width* de siete números.
...
En el siguiente artículo discutiremos más sobre la clase *GRanges*. Veremos la clase *GRangesList* donde formaremos listas de rangos genómicos, operaciones sobre estas listas, aplicaciones en datos reales y le daremos sentido biológico a las operaciones de la clase *IRanges*.
